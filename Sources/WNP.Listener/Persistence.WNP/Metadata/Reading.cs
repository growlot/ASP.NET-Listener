...
public class ReadingTable: ITableInformation {
		/// <summary>
	...
	/// <para />Is Primary Key: False
	/// </summary>
	public string ReadIndex { get; } = "read_index";
		/// <summary>
	/// <para />Database Type: string
	...
	/// <para />Is Primary Key: False
	/// </summary>
	public string EventFlag { get; } = "event_flag";
		/// <summary>
	/// <para />Database Type: string
	/// <para />Is Nullable: True
	/// <para />Is Primary Key: False
	...
	/// <para />Is Primary Key: False
	/// </summary>
	public string ReadSrc { get; } = "read_src";
		/// <summary>
	/// <para />Database Type: DateTime
	/// <para />Is Nullable: True
	/// <para />Is Primary Key: False
	/// </summary>
	public string ReadDate { get; } = "read_date";
		/// <summary>
	/// <para />Database Type: string
	/// <para />Is Nullable: True
	/// <para />Is Primary Key: False
	/// </summary>
	public string ReadBy { get; } = "read_by";
		/// <summary>
	/// <para />Database Type: DateTime
	/// <para />Is Nullable: True
	/// <para />Is Primary Key: False
	...
	{
		get { return "TREADING".ToUpperInvariant(); }		
	}
