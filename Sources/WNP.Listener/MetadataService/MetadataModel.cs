...
namespace AMSLLC.Listener.MetadataService
{
    public class MetadataModel
    {
        ...
        public MetadataModel(string tableName, string className, Dictionary<string, string> modelToColumnMappings, Dictionary<string, string> columnToModelMappings, Dictionary<string, MetadataFieldInfo> fieldInfo)
        {
