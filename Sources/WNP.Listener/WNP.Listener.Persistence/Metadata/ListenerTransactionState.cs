...
public class ListenerTransactionStateImpl: ITableInformation {
		/// <summary>
	...
	/// </summary>
	public string TransactionStateDesc = "transaction_state_desc";
		/// <summary>
	...
	{
		get { return "tlistener_transaction_state".ToLowerInvariant(); }		
	}
