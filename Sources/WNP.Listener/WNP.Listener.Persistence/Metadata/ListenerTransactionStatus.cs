...
public class ListenerTransactionStatusImpl: ITableInformation {
		/// <summary>
	...
	/// </summary>
	public string TransactionStatusDesc = "transaction_status_desc";
		/// <summary>
	...
	{
		get { return "tlistener_transaction_status".ToLowerInvariant(); }		
	}
