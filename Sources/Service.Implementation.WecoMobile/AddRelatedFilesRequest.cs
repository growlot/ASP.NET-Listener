//-----------------------------------------------------------------------
// <copyright file="AddRelatedFilesRequest.cs" company="Advanced Metering Services LLC">
...
namespace AMSLLC.Listener.Service.Implementation.WecoMobile
{
    ...
    /// </summary>
    public class AddRelatedFilesRequest
    {
        /// <summary>
        ...
        public ICollection<AddRelatedFileRequest> RelatedFiles { get; set; }
    }
}
